...
public class MapperParser extends Parser {
	...
	public static final int
		...
		INT=46, BOOL=47, AND=48, OR=49, NOT=50, IDENTIFIER=51, STRING=52, WS=53, 
		DOT=54, ERROR=55, SINGLE_LINE_COMMENT=56, MULTI_LINE_COMMENT=57;
	public static final int
		RULE_program = 0, RULE_statement = 1, RULE_block = 2, RULE_errorStatement = 3, 
		RULE_printStatement = 4, RULE_param = 5, RULE_type = 6, RULE_functionDecl = 7, 
		RULE_functionCall = 8, RULE_exprList = 9, RULE_increment = 10, RULE_tileSum = 11, 
		RULE_reasignment = 12, RULE_assignment = 13, RULE_noValueAssign = 14, 
		RULE_tileAssign = 15, RULE_numberAssign = 16, RULE_boolAssign = 17, RULE_blendAssign = 18, 
		RULE_roadStart = 19, RULE_roadPlacement = 20, RULE_roadEnd = 21, RULE_figure = 22, 
		RULE_blendOption = 23, RULE_drawRoad = 24, RULE_draw = 25, RULE_percentagePair = 26, 
		RULE_move = 27, RULE_loop = 28, RULE_whileLoop = 29, RULE_forLoop = 30, 
		RULE_conditional = 31, RULE_ifConditionStatements = 32, RULE_elseConditionStatements = 33, 
		RULE_expr = 34, RULE_exprComp = 35;
	private static String[] makeRuleNames() {
		return new String[] {
			"program", "statement", "block", "errorStatement", "printStatement", 
			"param", "type", "functionDecl", "functionCall", "exprList", "increment", 
			"tileSum", "reasignment", "assignment", "noValueAssign", "tileAssign", 
			"numberAssign", "boolAssign", "blendAssign", "roadStart", "roadPlacement", 
			"roadEnd", "figure", "blendOption", "drawRoad", "draw", "percentagePair", 
			"move", "loop", "whileLoop", "forLoop", "conditional", "ifConditionStatements", 
			"elseConditionStatements", "expr", "exprComp"
		};
	}
	...
	private static String[] makeSymbolicNames() {
		return new String[] {
			...
			"AND", "OR", "NOT", "IDENTIFIER", "STRING", "WS", "DOT", "ERROR", "SINGLE_LINE_COMMENT", 
			"MULTI_LINE_COMMENT"
		};
	}
	...
	public final ProgramContext program() throws RecognitionException {
		...
		try {
			...
			_la = _input.LA(1);
			while ((((_la) & ~0x3f) == 0 && ((1L << _la) & 38280644245455098L) != 0)) {
				{
				{
				setState(72);
				statement();
	...
	public static class StatementContext extends ParserRuleContext {
		...
		public ReasignmentContext reasignment() {
			return getRuleContext(ReasignmentContext.class,0);
		}
	...
	public final FunctionCallContext functionCall() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			if ((((_la) & ~0x3f) == 0 && ((1L << _la) & 2462906046218496L) != 0)) {
				{
				setState(141);
				exprList();
				}
	...
	public final TileSumContext tileSum() throws RecognitionException {
		...
		enterRule(_localctx, 22, RULE_tileSum);
		int _la;
		try {
			enterOuterAlt(_localctx, 1);
			{
	...
	@SuppressWarnings("CheckReturnValue")
	public static class ReasignmentContext extends ParserRuleContext {
		public TerminalNode IDENTIFIER() { return getToken(MapperParser.IDENTIFIER, 0); }
		public ExprContext expr() {
			return getRuleContext(ExprContext.class,0);
		}
		public ReasignmentContext(ParserRuleContext parent, int invokingState) {
			super(parent, invokingState);
		}
		@Override public int getRuleIndex() { return RULE_reasignment; }
	}

	public final ReasignmentContext reasignment() throws RecognitionException {
		ReasignmentContext _localctx = new ReasignmentContext(_ctx, getState());
		enterRule(_localctx, 24, RULE_reasignment);
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(174);
	...
	public static class AssignmentContext extends ParserRuleContext {
		...
		public NoValueAssignContext noValueAssign() {
			return getRuleContext(NoValueAssignContext.class,0);
		}
		public ReasignmentContext reasignment() {
			return getRuleContext(ReasignmentContext.class,0);
		}
	...
	@SuppressWarnings("CheckReturnValue")
	public static class NoValueAssignContext extends ParserRuleContext {
		public TypeContext type() {
			return getRuleContext(TypeContext.class,0);
		}
		public TerminalNode IDENTIFIER() { return getToken(MapperParser.IDENTIFIER, 0); }
		public NoValueAssignContext(ParserRuleContext parent, int invokingState) {
			super(parent, invokingState);
		}
		@Override public int getRuleIndex() { return RULE_noValueAssign; }
	}

	public final NoValueAssignContext noValueAssign() throws RecognitionException {
		NoValueAssignContext _localctx = new NoValueAssignContext(_ctx, getState());
		enterRule(_localctx, 28, RULE_noValueAssign);
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(187);
	...
	public final TileAssignContext tileAssign() throws RecognitionException {
		...
		enterRule(_localctx, 30, RULE_tileAssign);
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(190);
	...
	public final NumberAssignContext numberAssign() throws RecognitionException {
		...
		enterRule(_localctx, 32, RULE_numberAssign);
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(195);
	...
	public final BoolAssignContext boolAssign() throws RecognitionException {
		...
		enterRule(_localctx, 34, RULE_boolAssign);
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(200);
	...
	public final RoadStartContext roadStart() throws RecognitionException {
		...
		enterRule(_localctx, 38, RULE_roadStart);
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(216);
	...
	public final RoadPlacementContext roadPlacement() throws RecognitionException {
		...
		enterRule(_localctx, 40, RULE_roadPlacement);
		try {
			setState(222);
			_errHandler.sync(this);
	...
	public final RoadEndContext roadEnd() throws RecognitionException {
		...
		enterRule(_localctx, 42, RULE_roadEnd);
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(224);
	...
	public final BlendOptionContext blendOption() throws RecognitionException {
		...
		enterRule(_localctx, 46, RULE_blendOption);
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(237);
	...
	public final DrawRoadContext drawRoad() throws RecognitionException {
		...
		enterRule(_localctx, 48, RULE_drawRoad);
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(242);
	...
	public final PercentagePairContext percentagePair() throws RecognitionException {
		...
		enterRule(_localctx, 52, RULE_percentagePair);
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(264);
	...
	public static class ConditionalContext extends ParserRuleContext {
		public IfConditionStatementsContext ifConditionStatements() {
			return getRuleContext(IfConditionStatementsContext.class,0);
		}
		public ExprCompContext exprComp() {
			return getRuleContext(ExprCompContext.class,0);
		}
		...
		public ElseConditionStatementsContext elseConditionStatements() {
			return getRuleContext(ElseConditionStatementsContext.class,0);
		}
	...
	@SuppressWarnings("CheckReturnValue")
	public static class IfConditionStatementsContext extends ParserRuleContext {
		public List<StatementContext> statement() {
			return getRuleContexts(StatementContext.class);
		}
		public StatementContext statement(int i) {
		...
		public IfConditionStatementsContext(ParserRuleContext parent, int invokingState) {
			super(parent, invokingState);
		}
		@Override public int getRuleIndex() { return RULE_ifConditionStatements; }
	}

	public final IfConditionStatementsContext ifConditionStatements() throws RecognitionException {
		IfConditionStatementsContext _localctx = new IfConditionStatementsContext(_ctx, getState());
		enterRule(_localctx, 64, RULE_ifConditionStatements);
		int _la;
		try {
			enterOuterAlt(_localctx, 1);
			{
	...
	@SuppressWarnings("CheckReturnValue")
	public static class ElseConditionStatementsContext extends ParserRuleContext {
		public List<StatementContext> statement() {
			return getRuleContexts(StatementContext.class);
		}
		public StatementContext statement(int i) {
		...
		public ElseConditionStatementsContext(ParserRuleContext parent, int invokingState) {
			super(parent, invokingState);
		}
		@Override public int getRuleIndex() { return RULE_elseConditionStatements; }
	}

	public final ElseConditionStatementsContext elseConditionStatements() throws RecognitionException {
		ElseConditionStatementsContext _localctx = new ElseConditionStatementsContext(_ctx, getState());
		enterRule(_localctx, 66, RULE_elseConditionStatements);
		int _la;
		try {
			enterOuterAlt(_localctx, 1);
			{
	...
	@SuppressWarnings("CheckReturnValue")
	public static class ExprAndContext extends ExprCompContext {
		...
		public TerminalNode AND() { return getToken(MapperParser.AND, 0); }
		public ExprAndContext(ExprCompContext ctx) { copyFrom(ctx); }
	}
	@SuppressWarnings("CheckReturnValue")
	public static class ExprCompRelContext extends ExprCompContext {
		public List<ExprContext> expr() {
			return getRuleContexts(ExprContext.class);
		}
		public ExprContext expr(int i) {
		...
		public ExprCompRelContext(ExprCompContext ctx) { copyFrom(ctx); }
	}
	@SuppressWarnings("CheckReturnValue")
	public static class ExprCompBoolContext extends ExprCompContext {
		public TerminalNode BOOL() { return getToken(MapperParser.BOOL, 0); }
		public ExprCompBoolContext(ExprCompContext ctx) { copyFrom(ctx); }
	}
	@SuppressWarnings("CheckReturnValue")
	public static class ExprCompVarContext extends ExprCompContext {
		public TerminalNode IDENTIFIER() { return getToken(MapperParser.IDENTIFIER, 0); }
		public ExprCompVarContext(ExprCompContext ctx) { copyFrom(ctx); }
	}
	@SuppressWarnings("CheckReturnValue")
	public static class ExprOrContext extends ExprCompContext {
		public List<ExprCompContext> exprComp() {
			return getRuleContexts(ExprCompContext.class);
		}
		public ExprCompContext exprComp(int i) {
		...
		public TerminalNode OR() { return getToken(MapperParser.OR, 0); }
		public ExprOrContext(ExprCompContext ctx) { copyFrom(ctx); }
	}
	@SuppressWarnings("CheckReturnValue")
	public static class ExprNotContext extends ExprCompContext {
		public TerminalNode NOT() { return getToken(MapperParser.NOT, 0); }
		public ExprCompContext exprComp() {
			return getRuleContext(ExprCompContext.class,0);
		}
		public ExprNotContext(ExprCompContext ctx) { copyFrom(ctx); }
	}
	@SuppressWarnings("CheckReturnValue")
	public static class ExprCompParensContext extends ExprCompContext {
		public ExprCompContext exprComp() {
			return getRuleContext(ExprCompContext.class,0);
		}
		public ExprCompParensContext(ExprCompContext ctx) { copyFrom(ctx); }
	}
	...
	private ExprCompContext exprComp(int _p) throws RecognitionException {
		ParserRuleContext _parentctx = _ctx;
		int _parentState = getState();
		ExprCompContext _localctx = new ExprCompContext(_ctx, _parentState);
		ExprCompContext _prevctx = _localctx;
		int _startState = 70;
		enterRecursionRule(_localctx, 70, RULE_exprComp, _p);
		int _la;
		try {
			int _alt;
			enterOuterAlt(_localctx, 1);
			...
			case 2:
				{
				_localctx = new ExprCompRelContext(_localctx);
				_ctx = _localctx;
				_prevctx = _localctx;
				setState(366);
				expr(0);
			...
			case 3:
				{
				_localctx = new ExprCompParensContext(_localctx);
				_ctx = _localctx;
				_prevctx = _localctx;
				setState(370);
				match(T__7);
			...
			case 4:
				{
				_localctx = new ExprCompBoolContext(_localctx);
				_ctx = _localctx;
				_prevctx = _localctx;
				setState(374);
				match(BOOL);
			...
			case 5:
				{
				_localctx = new ExprCompVarContext(_localctx);
				_ctx = _localctx;
				_prevctx = _localctx;
				setState(375);
				match(IDENTIFIER);
			...
			while ( _alt!=2 && _alt!=org.antlr.v4.runtime.atn.ATN.INVALID_ALT_NUMBER ) {
				if ( _alt==1 ) {
					...
					case 1:
						{
						_localctx = new ExprAndContext(new ExprCompContext(_parentctx, _parentState));
					...
					case 2:
						{
						_localctx = new ExprOrContext(new ExprCompContext(_parentctx, _parentState));
						pushNewRecursionContext(_localctx, _startState, RULE_exprComp);
						setState(381);
						if (!(precpred(_ctx, 5))) throw new FailedPredicateException(this, "precpred(_ctx, 5)");
						setState(382);
	...
	public boolean sempred(RuleContext _localctx, int ruleIndex, int predIndex) {
		...
		case 35:
			return exprComp_sempred((ExprCompContext)_localctx, predIndex);
		}
		return true;
	}
